...
function handleReplyBtnClick(replyId){
    const replyInput = document.getElementById(`reply-msg-${replyId}`)
    if(replyInput.value){
        const tweetReply = tweetsData.filter(function(tweet){
            return tweet.uuid === replyId
        })[0]
        
        tweetReply.replies.unshift({
                handle: `@Scrimba`,
                profilePic: `images/scrimbalogo.png`,
...
function getFeedHtml(){
    ...
    tweetsData.forEach(function(tweet){
        ...
        let repliesHtml = `<div class = "reply">
            <div class="reply-input-area">
			<textarea placeholder="Post your reply" id = "reply-msg-${tweet.uuid}" 
